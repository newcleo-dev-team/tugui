...
class PlotSettingsConfigurator():
  ...
  """
  def __init__(self, container: ttk.Frame, group: GroupType, row_index: int):
    """
    ...
    self.row_next = self.field3.row_next
    print("BUTTON ROW", self.row_next)

  def configure_fields(self,
                       field1_lbl: str = None, field1_cbx: list = None,
                       field2_lbl: str = "", field2_cbx: list = list(),
                       field3_lbl: str = "", field3_lbx: list = list()):
    """
  ...
  def is_everything_set(self, container: ttk.Frame):
    """
  ...
  def handle_selection(self, container: ttk.Frame, set_field):
    """
  ...
  def set_fields_type(self, field1_type: FieldType, field2_type: FieldType, field3_type: FieldType):
    """
...
class LabelledCombobox():
  ...
  def __init__(self, container: ttk.Frame, row_index: int, label_text: str, cbx_list: list, state: str='readonly'):
    ...
    self.label = ttk.Label(container, text=label_text)
    ...
    self.cbx = ttk.Combobox(container, textvariable=self.var, state=state, values=tuple(cbx_list))
...
class PlotSettingsField_2():
  ...
  . a combobox: providing a mean for choosing among different alternative values
  """
  def __init__(self, container, row_index: int, cbx_list: list):
    """
    ...
    """
    # Put a descriptive label
    self.label = ttk.Label(container, text="Time axis (h s ms): ")
    self.label.grid(column=0, row=row_index, sticky='w')
...
class PlotSettingsListBox():
  ...
  """
  def __init__(self, container: ttk.Frame, label_text: str, choices: list, row_index: int):
    """
    ...
    self.choicesvar = tk.StringVar(value=choices)
    # Instantiate the listbox
    self.choice_lb = tk.Listbox(
...
if __name__ == "__main__":
  ...
  plot_config = PlotSettingsConfigurator(mainframe, GroupType.group2, 0)
  ...
  plot_config2 = PlotSettingsField_2(mainframe, 6, ['0 0 0', '1 30 100', '2 0 0', '2 25 0'])
